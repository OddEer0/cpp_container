...
namespace s21 {
    ...
    public:
        ...
        private:
            ...
            bool isReverse_;
        public:
            Iterator() : array_(nullptr), index_(0), position_(START), isReverse_(false) {}
            Iterator(array *v, size_type index, int pos, bool isReverse = false) : array_(v), index_(index), position_(pos), isReverse_(isReverse) {};
            ~Iterator() {
                array_ = nullptr;
                index_ = 0;
                position_ = START;
