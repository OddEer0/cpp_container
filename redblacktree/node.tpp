...
typename RedBlackTree<Key, T, Compare, Allocator>::Node::node_type RedBlackTree<Key, T, Compare, Allocator>::Node::getLeft() {
    return left_;
}

template <class Key, class T, class Compare, class Allocator>
typename RedBlackTree<Key, T, Compare, Allocator>::Node::node_type RedBlackTree<Key, T, Compare, Allocator>::Node::getRight() {
    return right_;
}

template <class Key, class T, class Compare, class Allocator>
typename RedBlackTree<Key, T, Compare, Allocator>::Node::node_type RedBlackTree<Key, T, Compare, Allocator>::Node::getParent() {
    return parent_;
}

template <class Key, class T, class Compare, class Allocator>
typename RedBlackTree<Key, T, Compare, Allocator>::key_type RedBlackTree<Key, T, Compare, Allocator>::Node::getKey() {
    return data_->first;
}
