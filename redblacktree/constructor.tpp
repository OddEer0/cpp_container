...
RedBlackTree<Key, T, Compare, Allocator>::RedBlackTree(RedBlackTree& other)
    : root_(nullptr), length_(0), cmp_(other.cmp_), allocator_(other.allocator_) {
...
template <class Key, class T, class Compare, class Allocator>
RedBlackTree<Key, T, Compare, Allocator>& RedBlackTree<Key, T, Compare, Allocator>::operator=(RedBlackTree&& other) {
    if (this != &other) {
        clear();
        root_ = std::exchange(other.root_, nullptr);
        length_ = std::exchange(other.length_, 0);
