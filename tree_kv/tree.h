...
namespace s21 {
    ...
    public:
        ...
        std::string stringWithCallback(std::function<std::string(key_type)> callback, bool withColor = false);
        void outputWithCallback(node_type node, std::string prefix, bool isTail, std::string* str, std::function<std::string(key_type)> callback, bool withColor = false);
