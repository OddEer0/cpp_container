...
template <class Key, class Compare, class Allocator>
std::pair<typename RedBlackTree<Key, Compare, Allocator>::iterator, bool> RedBlackTree<Key, Compare, Allocator>::insert(key_type value) {
...
template <class Key, class Compare, class Allocator>
std::optional<typename RedBlackTree<Key, Compare, Allocator>::key_type> RedBlackTree<Key, Compare, Allocator>::extract(key_type key ) {
...
template <class Key, class Compare, class Allocator>
std::optional<typename RedBlackTree<Key, Compare, Allocator>::key_type> RedBlackTree<Key, Compare, Allocator>::extract(iterator position) {
...
template <class Key, class Compare, class Allocator>
typename RedBlackTree<Key, Compare, Allocator>::size_type RedBlackTree<Key, Compare, Allocator>::erase(iterator pos) {
...
template <class Key, class Compare, class Allocator>
typename RedBlackTree<Key, Compare, Allocator>::size_type RedBlackTree<Key, Compare, Allocator>::erase(key_type key) {
...
void RedBlackTree<Key, Compare, Allocator>::insert(InputIt first, InputIt last) {
...
template <class Key, class Compare, class Allocator>
void RedBlackTree<Key, Compare, Allocator>::insert(std::initializer_list<key_type> ilist) {
    for (auto elem : ilist) {
        insert(elem);
    }
}